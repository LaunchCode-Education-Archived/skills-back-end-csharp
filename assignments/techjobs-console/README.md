...
The applicaiton will run until you force it to quit, reprompting time after time. To kill it, ctrl+C and then stop debugging via the red "stop" icon in the Debug toolbar. We'll learn precisely how the program manages to work this way below.
</aside>
